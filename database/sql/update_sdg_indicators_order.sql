UPDATE sdg_indicators SET lft = 1 WHERE code = '1.2.1' ; 
UPDATE sdg_indicators SET lft = 2 WHERE code = '1.4.2.a' ; 
UPDATE sdg_indicators SET lft = 3 WHERE code = '1.4.2.b' ; 
UPDATE sdg_indicators SET lft = 4 WHERE code = '2.2.1' ; 

UPDATE sdg_indicators SET lft = 5 WHERE code = '3.2.1' ; 
UPDATE sdg_indicators SET lft = 6 WHERE code = '4.1.1.a.i' ; 
UPDATE sdg_indicators SET lft = 7 WHERE code = '4.1.1.a.ii' ; 
UPDATE sdg_indicators SET lft = 8 WHERE code = '4.1.1.b.i' ; 

UPDATE sdg_indicators SET lft = 9 WHERE code = '4.1.1.b.ii' ; 
UPDATE sdg_indicators SET lft = 10 WHERE code = '4.1.1.c.i' ; 
